...
console.log('Welcome to LaunchCode great workplace');
...
Modify your code on line 7 to try to accomplish the tasks listed below:
   ...
   Ans:- Did console.log("Hello, World");
   ...
   Ans:- We can use either but both qutes have to be same i.e.  both "" or ''.
   
   4. Remove the semi-colon, ;.
   Ans:- It will work.

   5. Print a number. (Bonus: Print two numbers added together).
   Ans:- console.log(5); and console.log(5+6);
   ...
   Ans:- console.log("Hello, World " + "and welcome!");   
